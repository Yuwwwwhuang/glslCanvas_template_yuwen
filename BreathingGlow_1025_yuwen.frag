...
void main() {
    ...
    //亂數作用雲霧
    float fog= fbm(0.488*uv+vec2(-0.1*u_time, 0.052*u_time))*0.6+0.1;
    ...
    float noise = gnoise(uv_flip*12.)*0.196*weight;  //frenquency＆扭曲程度
    ...
    gl_FragColor = vec4((glow_model+fog)*dir*vec3(1.000,0.325,0.611),1.248);
