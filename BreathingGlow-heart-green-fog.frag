...
for (int index=0; index<9; ++index)    
{
    ...
    float model_dist = abs(heart(uv_flip,0.756))+noise; //heart
    ...
    gl_FragColor = vec4((result*vec3(1.000,0.325,0.611)+fog*0.003*u_time*vec3(0.326,0.785,0.155))*0.3,1.248); //*0.3降低整體亮度
